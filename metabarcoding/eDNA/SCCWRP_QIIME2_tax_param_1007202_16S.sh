...
homePATH="/home/kyliel" # Path to the parent directory.  Should NOT finish with "/"
workingPATH="10072021_16S_V4"  	#Path to  where the fastqs are stored. Should NOT finish with "/" It must be located in the parent directory.
