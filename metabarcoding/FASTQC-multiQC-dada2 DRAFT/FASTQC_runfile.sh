...
workingPATH="/Users/kylielanglois/Desktop/FASTQC_attempt_070323/fastq_multiqc_dada2_test_072023"  	# Path to the parent directory. It is not the directory where are stored the fastqs. Should NOT finish with "/"
fastq_directory=$workingPATH/"06152023_CO1_fastq"	# Name of the folder containing the fastqs. It must be located in the parent directory.
...
cd fastqc-R1
multiqc --export .
FASTQC_VAR1_80=$($scriptsPATH/fastqc_per_base_sequence_quality_dropoff.py  --input $fastq_directory/"fastqc-R1/multiqc_data/mqc_fastqc_per_base_sequence_quality_plot_1.txt" --cutoff 0.8)
...
cd fastqc-R2
multiqc --export .
FASTQC_VAR2_80=$($scriptsPATH/fastqc_per_base_sequence_quality_dropoff.py --input $fastq_directory/"fastqc-R2/multiqc_data/mqc_fastqc_per_base_sequence_quality_plot_1.txt" --cutoff 0.8)
...
cd $scriptsPATH
Rscript --vanilla dada2_filteronly_runfile.r ${fastq_directory} ${FASTQC_VAR1_80} ${FASTQC_VAR2_80}
...
Rscript --vanilla dada2_filteronly_runfile.r ${fastq_directory} ${FASTQC_VAR1_85} ${FASTQC_VAR2_85}
DADA2_VAR_85=$(sed '2q;d' $fastq_directory/average_quality.txt)
rm $fastq_directory/filtered/*_filt.fastq.gz
rmdir $fastq_directory/filtered


Rscript --vanilla dada2_filteronly_runfile.r ${fastq_directory} ${FASTQC_VAR1_90} ${FASTQC_VAR2_90}
DADA2_VAR_90=$(sed '2q;d' $fastq_directory/average_quality.txt)
rm $fastq_directory/filtered/*_filt.fastq.gz
rmdir $fastq_directory/filtered


Rscript --vanilla dada2_filteronly_runfile.r ${fastq_directory} ${FASTQC_VAR1_95} ${FASTQC_VAR2_95}
