...
#user input-------------------
project_shortname="BIO_eDNAdecay_16S_112124" #PUT PROJECT SHORT NAME HERE
fastq_directory=$rawPATH/"BIO_eDNAdecay_16S_112124/fastq"	# Name of the folder containing the fastqs. It must be located in the parent directory. Should NOT finish with "/"
