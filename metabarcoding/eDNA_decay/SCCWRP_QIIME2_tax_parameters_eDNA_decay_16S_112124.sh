...
processedPATH="/home/genomics/processed/BIO_eDNAdecay_16S_102924" # Path to the processed files will be housed. Should NOT finish with "/"
sampReads=$processedPATH/"eDNA_decay_16S_102924_mergerTO_rep_set" #Path to the sample sequences are stored. Should NOT finish with "/"
project_shortname="eDNA_decay_16S_102924_mergerTO"
