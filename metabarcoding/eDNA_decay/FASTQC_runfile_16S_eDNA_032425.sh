...
#user input-------------------
project_shortname="BIO_eDNA_16S_032425" #PUT PROJECT SHORT NAME HERE
fastq_directory=$rawPATH/"BIO_eDNA_16S_032425/fastq_files"	# Name of the folder containing the fastqs. It must be located in the parent directory. Should NOT finish with "/"
