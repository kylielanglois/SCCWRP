...
scriptsPATH="/home/genomics/scripts/cutadapt-FASTQC-multiQC-dada2_scripts" #where scripts are located; must contain fastqc_per_base_sequence_quality_dropoff.py dada2_runfile2_16S_eDNAdecay_102924_16S_eDNAdecay_102924.r Should NOT finish with "/"
...
FASTQC_VAR1=$($scriptsPATH/fastqc_per_base_sequence_quality_dropoff.py  --input $processed_directory/"fastqc-R1/multiqc_data_2/mqc_fastqc_per_base_sequence_quality_plot_1.txt" --cutoff 1)
echo $FASTQC_VAR1

cd $processed_directory/fastqc-R2
FASTQC_VAR2=$($scriptsPATH/fastqc_per_base_sequence_quality_dropoff.py --input $processed_directory/"fastqc-R2/multiqc_data_2/mqc_fastqc_per_base_sequence_quality_plot_1.txt" --cutoff 1)
echo $FASTQC_VAR2
...
cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR0} ${TRIM2_VAR0}
...
cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR1} ${TRIM2_VAR1}
DADA2_VAR_1=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR1} ${TRIM2_VAR2}
DADA2_VAR_2=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR2} ${TRIM2_VAR2}
DADA2_VAR_3=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR2} ${TRIM2_VAR3}
DADA2_VAR_4=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR3} ${TRIM2_VAR3}
DADA2_VAR_5=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR3} ${TRIM2_VAR4}
DADA2_VAR_6=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR4} ${TRIM2_VAR4}
DADA2_VAR_7=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR4} ${TRIM2_VAR5}
DADA2_VAR_8=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR5} ${TRIM2_VAR5}
DADA2_VAR_9=$(sed '2q;d' $trimmed_fastqPATH/average_quality_V2.txt)
rm $trimmed_fastqPATH/filtered/*_filt.fastq.gz
rmdir $trimmed_fastqPATH/filtered

cd $scriptsPATH
Rscript --vanilla dada2_runfile2_16S_eDNAdecay_102924.r ${trimmed_fastqPATH} ${TRIM1_VAR5} ${TRIM2_VAR6}
