...
#user input-------------------
project_shortname="BIO_CTAB_12S_012925" #PUT PROJECT SHORT NAME HERE
fastq_directory=$rawPATH/"BIO_CTAB_12S_012925/fastq_12S"	# Name of the folder containing the fastqs. It must be located in the parent directory. Should NOT finish with "/"
