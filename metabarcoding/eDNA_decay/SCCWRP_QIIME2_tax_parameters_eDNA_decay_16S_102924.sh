...
processedPATH="/home/genomics/processed/BIO_eDNAdecay_16S_102924/trimmed_fastq" # Path to the processed files will be housed. Should NOT finish with "/"
sampReads=$processedPATH/"eDNA_decay_16S_102924_merger7_rep_set" #Path to the sample sequences are stored. Should NOT finish with "/"
project_shortname="eDNA_decay_16S_102924_merger7"
refName="silva_138_99" #name of assay
