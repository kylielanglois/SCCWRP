...
#user input-------------------
project_shortname="16S_V4V5_060221" #PUT PROJECT SHORT NAME HERE
fastq_directory=$rawPATH/"060221_16S_V4V5_demux"	# Name of the folder containing the fastqs. It must be located in the parent directory. Should NOT finish with "/"
