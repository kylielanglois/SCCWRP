...
#user input-------------------
project_shortname="16S_V4V5_Apr2023" #PUT PROJECT SHORT NAME HERE
fastq_directory=$rawPATH/"Apr_2023_V4V5_600_cycle"	# Name of the folder containing the fastqs. It must be located in the parent directory. Should NOT finish with "/"
