...
sourcetracker2 -i SDIO_indiv_combo_table_norep_nobl_nozero.biom -m SD_IO_metadata_combo_012624_norep_nobl_nozero_SS_fullSD.txt --source_rarefaction_depth 0 --sink_rarefaction_depth 0 --jobs 4 --per_sink_feature_assignments --source_sink_column SS --source_column_value source --sink_column_value sink -o SDIO_combo_2024_fullSD_st2_result_sg
