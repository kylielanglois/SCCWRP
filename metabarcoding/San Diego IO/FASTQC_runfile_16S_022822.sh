...
#user input-------------------
project_shortname="16S_V4V5_022822_2" #PUT PROJECT SHORT NAME HERE
fastq_directory=$rawPATH/"02282022_16SV4V5_deumx"	# Name of the folder containing the fastqs. It must be located in the parent directory. Should NOT finish with "/"
