...
#files------
path <- "/Users/kylielanglois/OneDrive - SCCWRP/SD I-O data/revisits_demux_newnames2024/"
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(250,175), #based on multiQC reports
...
#export----------
write.csv(track, 
          "/Users/kylielanglois/OneDrive - SCCWRP/SD I-O data/all SD IO 010824/fastqc_multiqc_dada2_filteronly_results_revisits21_newnames2024.csv")

seqtab.nochim1<-as.data.frame(t(seqtab.nochim))
write.csv(seqtab.nochim1, 
          "/Users/kylielanglois/OneDrive - SCCWRP/SD I-O data/all SD IO 010824/SDIO_revisits21newnames2024_NA_merger.csv")
write.table(seqtab.nochim1, sep="\t",
            "/Users/kylielanglois/OneDrive - SCCWRP/SD I-O data/all SD IO 010824/SDIO_revisits21newnames2024_NA_merger.txt")
